...
const ProgressBaseBar = styled.div`
  background-color: ${(props: {state: ProgressIntegrateStates, width: string}) => colorWithState(props.state)};
  height: 100%;
  width: ${(props: {state: ProgressIntegrateStates, width: string}) => props.width};
`;
...
const Progress = styled.div`
  ...
  animation-play-state: ${(props: {state: any, onAnimationEnd: any}) => animationPlayState(props.state)};
`;
